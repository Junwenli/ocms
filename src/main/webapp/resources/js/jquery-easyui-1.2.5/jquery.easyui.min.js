...
/** edit by sam **/
var _fromNum = _6b.pageSize*(_6b.pageNumber-1)+1;
if(_6b.total==0) _fromNum = 0;
_6d=_6d.replace(/{from}/,_fromNum);
...
if(data.indexOf('登录页面login.jsp')!=-1){
	window.location.href=basePath+"/j_spring_security_logout";//点击菜单打开页面，如果 session过期则跳转到登录页 IE by zml
}
...
leftshow:function(_1f1){
	if(input_top_remind_status == "1"){
		$.messager.alert('提示', _1f1.msg, "icon-ok", function() {});
	}else{
	var opts=$.extend({showType:"slide",showSpeed:600,width:250,height:100,msg:"",title:"",timeout:4000},_1f1||{});
	var win=$("<div class=\"messager-body\" style=\"background-color:#fffacf;border-top: 1px solid #CCCCCC;\"></div>").html(opts.msg).appendTo("body");
	win.window({title:opts.title,width:opts.width,height:60,collapsible:false,minimizable:false,maximizable:false,shadow:false,draggable:false,resizable:false,closed:true,onBeforeOpen:function(){
	show(this,opts.showType,opts.showSpeed,opts.timeout);
	return false;
	},onBeforeClose:function(){
	hide(this,opts.showType,opts.showSpeed);
	...
	win.window("window").css({left:"",top:"",left:windowWidth-250,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop});
	win.window("open");
	}
},
rightshow:function(_1f1){
	if(input_top_remind_status == "1"){
		$.messager.alert('提示', _1f1.msg, "icon-ok", function() {});
	}else{
	var opts=$.extend({showType:"slide",showSpeed:600,width:250,height:100,msg:"",title:"",timeout:4000},_1f1||{});
...
//对选项卡增加提示 by zml
var tip;
if(_261.tip!=undefined){
	tip = _261.tip;
}else{
	tip = opts.title;
}

var _263=$("<a href=\"javascript:void(0)\" title=\""+tip+"\" class=\"tabs-inner\"></a>").appendTo(tab);
...
//增加排序字段 by zml
if(col.orderField){
td.attr("order-field",col.orderField);
}
//增加排序字段 by zml
...
var _424;
//增加排序字段 by zml
if($(this).parent().attr("order-field")){
	_424=$(this).parent().attr("order-field");
}else{
	_424=$(this).parent().attr("field");
}
//增加排序字段 by zml
...
var col=cols[j];
//增加排序字段 by zml
if(col.field==_445||col.orderField==_445){
return col;
}
}
}

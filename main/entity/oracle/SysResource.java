...
public class SysResource {
	...
	@Id
	@SequenceGenerator(name = "permissionGenerator", sequenceName = "S_T_SYS_PERMISSION", allocationSize = 1 )
	@GeneratedValue(generator = "permissionGenerator", strategy = GenerationType.SEQUENCE)
